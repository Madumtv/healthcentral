        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Toute votre santé, organisée simplement : traitements, contacts et piluliers réunis
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link to="/about">
                <Button size="lg" variant="outline" className="border-white text-blue-600 bg-white hover:bg-gray-100 font-semibold px-8">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Pourquoi choisir HealthCentral?
              </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Rejoignez des milliers d'utilisateurs qui font déjà confiance à HealthCentral pour leur santé
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/auth">
